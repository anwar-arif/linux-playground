...
echo ""
echo "Files created:"
echo "- simulate_high_cpu.sh"
echo "- simulate_disk_full.sh"  
echo "- simulate_memory_leak.sh"
echo "- simulate_network_issues.sh"
echo "- simulate_permission_issues.sh"
echo "- simulate_service_issues.sh"
echo "- simulate_log_issues.sh"
echo "- run_troubleshooting_scenarios.sh (master script)"
echo ""
echo "To start practicing: ./run_troubleshooting_scenarios.sh"