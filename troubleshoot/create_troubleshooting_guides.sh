#!/bin/bash
# This script creates the troubleshooting_guides.sh file

cat << 'EOF' > troubleshooting_guides.sh
#!/bin/bash
...
chmod +x troubleshooting_guides.sh

echo "✅ troubleshooting_guides.sh file created successfully!"
echo ""
echo "You can now use it with:"
echo "bash troubleshooting_guides.sh cpu"
echo "bash troubleshooting_guides.sh disk"
echo "bash troubleshooting_guides.sh memory"
echo "etc..."